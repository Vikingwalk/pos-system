...
public class LoginController {
    ...
    private void initializeCashierController(Scene cashierScene) {
        try {
            ...
            TextField discountField = (TextField) components.get("discountField");
            ...
            new CashierController(productTable, searchField, searchButton, cartTable,
                                productIdField, quantityField, addToCartButton, discountField,
                                totalLabel, discountLabel, finalTotalLabel, checkoutButton,
                                printReceiptButton, clearCartButton, logoutButton);
